...
"}")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 196, 269))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 196, 269))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/external-link.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.open_close_side_bar_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.open_close_side_bar_btn.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/align-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_close_side_bar_btn.setIcon(icon2)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/bell.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.frame_13.setGeometry(QtCore.QRect(0, 0, 250, 150))
        self.frame_13.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_13.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_13.setObjectName("frame_13")
        self.label_5 = QtWidgets.QLabel(self.frame_13)
        self.label_5.setGeometry(QtCore.QRect(10, 10, 111, 16))
        self.label_5.setObjectName("label_5")
        self.textEdit = QtWidgets.QTextEdit(self.frame_13)
        self.textEdit.setGeometry(QtCore.QRect(6, 30, 151, 31))
        self.textEdit.setObjectName("textEdit")
        self.frame_14 = QtWidgets.QFrame(self.frame_12)
        self.frame_14.setGeometry(QtCore.QRect(250, 0, 250, 150))
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(16, 30, 141, 31))
        self.textEdit_2.setObjectName("textEdit_2")
        self.frame_15 = QtWidgets.QFrame(self.frame_12)
        self.frame_15.setGeometry(QtCore.QRect(0, 150, 250, 150))
        ...
        self.textEdit_3 = QtWidgets.QTextEdit(self.frame_15)
        self.textEdit_3.setGeometry(QtCore.QRect(6, 50, 141, 31))
        self.textEdit_3.setObjectName("textEdit_3")
        self.frame_16 = QtWidgets.QFrame(self.frame_12)
        self.frame_16.setGeometry(QtCore.QRect(250, 150, 250, 150))
        self.frame_16.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_16.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_16.setObjectName("frame_16")
        self.report_gen_button = QtWidgets.QPushButton(self.frame_16)
        self.report_gen_button.setGeometry(QtCore.QRect(-11, 50, 211, 32))
        self.report_gen_button.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/aperture.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.report_gen_button.setIcon(icon9)
        self.report_gen_button.setObjectName("report_gen_button")
        self.generator = QtWidgets.QPushButton(self.frame_16)
        self.generator.setGeometry(QtCore.QRect(10, 20, 141, 32))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/cpu.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.generator.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/box.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "RAGNAROK"))
        self.pushButton_10.setText(_translate("MainWindow", "UI Recources"))
        self.pushButton_11.setText(_translate("MainWindow", "Probes Recources"))
        self.pushButton_12.setText(_translate("MainWindow", "Server/Client Recources"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("MainWindow", "Github Recources"))
        self.pushButton_13.setText(_translate("MainWindow", "PyQt Library"))
        self.pushButton_14.setText(_translate("MainWindow", "PlugyPy v1.2.2"))
        self.label_4.setText(_translate("MainWindow", "I would like to thank my mentor Ivan Zlatanov for providing me with usefull resources and information"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "External Libraries Used"))
        self.exit_button.setText(_translate("MainWindow", "Exit"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Search"))
        self.label_5.setText(_translate("MainWindow", "Port Scanner"))
        self.textEdit.setPlaceholderText(_translate("MainWindow", "Enter network "))
        self.label_6.setText(_translate("MainWindow", "ARP Fingerprinting"))
        self.textEdit_2.setPlaceholderText(_translate("MainWindow", "Enter local device"))
        self.label_7.setText(_translate("MainWindow", "Background Proccesses"))
        self.textEdit_3.setPlaceholderText(_translate("MainWindow", "Enter process name"))
        self.report_gen_button.setText(_translate("MainWindow", "Click to Open Output"))
        self.generator.setText(_translate("MainWindow", "Generate Report"))
        self.label.setText(_translate("MainWindow", "RAGNAROK v0.1"))
import icons_rc
